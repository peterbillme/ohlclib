...
if __name__ == '__main__':
    ...
    ema(data=_hist_data, periods=[21, 60, 120])

    bias(data=_hist_data, base_column='close', relative_column='ema_21_close', bias_name='bias_close_21')
    bias(data=_hist_data, base_column='ema_21_close', relative_column='ema_60_close', bias_name='bias_21_60')
